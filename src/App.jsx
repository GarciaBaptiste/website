...
import ThumbFranceArchives from './assets/projects/francearchives/francearchives_mockup.jpg'
import ThumbFranceArchivesPH from './assets/projects/francearchives/francearchives_mockup_placeholder.jpg'
  ...
  const projectData = [
    {
      ...
      customContent: (
        <span class="contact-info">
          <br />
          Feel free to{' '}
          <ContactButton onClick={toggleModal}>get in touch</ContactButton>! I'm
          also on{' '}
          <a href="https://www.malt.fr/profile/baptistegarcia1" target="blank">
            Malt <ArrowExternal />
          </a>
          .
        </span>
